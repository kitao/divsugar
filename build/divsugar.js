...
(function() {
  ...
  DivSugar.Matrix = (function() {
    ...
    Matrix.prototype.rotateAround = function() {
      var a, a2, ab, ac, axis, b, b2, bc, c, c2, cos, mat, point, rad, sin, vec;
      switch (arguments.length) {
        case 2:
          axis = arguments[0];
          a = axis.x;
          ...
          cos = Math.cos(rad);
          mat = DivSugar.Matrix._tmpMat1;
          mat.set(a2 + (1 - a2) * cos, ab * (1 - cos) + c * sin, ac * (1 - cos) - b * sin, ab * (1 - cos) - c * sin, b2 + (1 - b2) * cos, bc * (1 - cos) + a * sin, ac * (1 - cos) + b * sin, bc * (1 - cos) - a * sin, c2 + (1 - c2) * cos, 0, 0, 0).toGlobal(this);
          this.set(mat);
          break;
        case 3:
          point = arguments[0];
          vec = DivSugar.Matrix._tmpVec1;
          vec.set(point).toLocal(this);
          axis = arguments[1];
          a = axis.x;
          b = axis.y;
          c = axis.z;
          ...
          mat.set(a2 + (1 - a2) * cos, ab * (1 - cos) + c * sin, ac * (1 - cos) - b * sin, ab * (1 - cos) - c * sin, b2 + (1 - b2) * cos, bc * (1 - cos) + a * sin, ac * (1 - cos) + b * sin, bc * (1 - cos) - a * sin, c2 + (1 - c2) * cos, 0, 0, 0).toGlobal(this);
          this.set(mat);
          vec.toGlobal_noTrans(this);
          this.trans.set(point).sub(vec);
          break;
        default:
          throw 'DivSugar: Invalid number of arguments';
      }
  ...
  DivSugar.Node = (function() {
    ...
    Node.prototype.rotateAround = function() {
      var args, _ref;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (arguments.length !== 2 && arguments.length !== 3) {
        throw 'DivSugar: Invalid number of arguments';
      }
      (_ref = this._transform).rotateAround.apply(_ref, args);
      this.div.style[DivSugar._cssTransform] = this._transform._toCSSTransform();
      return this;
    };
    ...
    Node.prototype._updateAnimation = function(animTask) {
      var a0, a1, anim, clip, command, i, param, pos, size, value, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
        ...
        switch (command[0]) {
              ...
              for (param in _ref2) {
                ...
                switch (param) {
                  ...
                  case 'position':
                    ...
                    break;
                  case 'transform':
                    if ((_ref3 = animTask._fromTransform) == null) {
                  ...
                  case 'imageClip':
                    ...
                    break;
                  case 'translate':
                    if ((_ref4 = animTask._fromTransform) == null) {
                      animTask._fromTransform = new DivSugar.Matrix(this._transform);
                    }
                    break;
                  case 'rotate':
                    if ((_ref5 = animTask._fromTransform) == null) {
                      animTask._fromTransform = new DivSugar.Matrix(this._transform);
                    }
                    break;
                  case 'scale':
                    if ((_ref6 = animTask._fromTransform) == null) {
                      animTask._fromTransform = new DivSugar.Matrix(this._transform);
                    }
                    break;
                  default:
          ...
          case 'repeat':
            if (animTask._repeatCount == null) {
              animTask._repeatCount = (_ref8 = command[1]) != null ? _ref8 : -1;
            }
    ...
    Node.prototype.clearAnimation = function() {
